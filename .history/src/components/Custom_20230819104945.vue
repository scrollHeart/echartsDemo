...
export default {
    ...
    data() {
        return {
            ...
            setIndexArr: [],
            oldPosiYObj: {},
            // 策略映射关系:type1、type2、type3、type4、type5、type6
            mapObj: {
                '1': 'type1',
                '2': 'type2',
                '3': 'type3',
                ...
                tooltip: {
                    ...
                    formatter: params => {
                        if (!params.length) {
                            ...
                            <br/>${params.seriesName}：${val ? val[1] : '-'}`;
                        }
                    },
                    axisPointer: {
                        type: 'cross',
                            ...
                            case '2':
                                ...
                                optionObj.color = {
                                    ...
                                    colorStops: [
                                        ...
                                        {
                                            offset: 0.92,
                                            color: '#de28c6', // 100% 处的颜色
                                        },
                                    ],
                                    global: false, // 缺省为 false
                                };
                                optionObj.borderColor = '#f40'; // 7b066c
                                optionObj.lineColor = '#f40';
                                break;
                            case '3':
                                optionObj.name = 'type3';
                                optionObj.color = {
                                    type: 'linear',
                                    x: 0,
                                    y: 0,
                                ...
                                optionObj.borderColor = '#0baabe';
                                optionObj.lineColor = '#0baabe';
                                break;
                            case '4':
                                optionObj.name = 'type4';
                                optionObj.color = {
                                    type: 'linear',
                                    x: 0,
                                    y: 0,
                                    ...
                                    colorStops: [
                                        ...
                                        {
                                            offset: 0.92,
                                            color: '#278007', // 100% 处的颜色
                                        },
                                    ],
                                    global: false, // 缺省为 false
                                };
                                optionObj.borderColor = '#067e0f';
                                optionObj.lineColor = '#067e0f';
                                break;
                            case '5':
                                optionObj.name = 'type5';
                                optionObj.color = {
                                    type: 'linear',
                                    x: 0,
                                    y: 0,
                                ...
                                optionObj.borderColor = '#c0aa0f';
                                optionObj.lineColor = '#c0aa0f';
                                break;
                            case '6':
                                optionObj.name = 'type6';
                                optionObj.color = {
                                    type: 'linear',
                                    x: 0,
                                    y: 0,
