        ...
        updateChart() {
            ...
            this.chartRef.on('legendselectchanged', (e) => {
                ...
                this.dubbleIndexArr.forEach(i => {
                    console.log(this.chartOptions[i], 'this.chartOptions[i]')
                ...
                console.log(setIndex, curdubbleIndexArr, 'index')
                ...
                if (!e.selected[e.name]) {
                    console.log(this.optionColorArr, 'optionColorArr')
                    console.log(this.optionColorArr, 'optionColorArr')
                    for(let key in this.mapObj) {
                        if (this.mapObj[key] === e.name) {
                            console.log(key, 'key')
                            eKey = key;
                            console.log(this.dubbleIndexArr, 'this.dubbleIndexArr')
                    ...
                    console.log(aboutMapArr, 'aboutMapArr')
                    ...
                    for (let j = 0; j < aboutMapArr.length; j++) {
                        ...
                        // if ((this.optionColorArr).indexOf(`${aboutMapArr[j]}/${eKey}`) || (this.optionColorArr).indexOf(`${eKey}/${aboutMapArr[j]}`)) {
                        //     console.log('进来了')
                        // }

                        // let aboutIndex = this.valArrs.lastIndexOf(aboutMapArr[j]);
                        // this.posiYObj[aboutIndex] = - height/2;
                    }
                    console.log(ttIndexArr, 'ttIndexArr')
                    ...
                    for (let j = 0; j < ttIndexArr.length; j++) {
                        ...
                        this.optionColorArr[num].split('/').forEach(i => {
                            debugger
                            let ss = this.optionColorArr[num].split('/').indexOf(i);

                            if (ss === 1) {
                                this.posiYObj[ind] = - height/2;
                                ind++;
                            }
                        })
                    ...
                    // console.log(num, 'num')
                    // let ssArr = this.optionColorArr[ttIndex].split('/');
                    // console.log(ssArr, 'ssArr')
                    // for (let k = 0; k < aboutMapArr.length; k++) {
                    //     console.log(ssArr.indexOf(aboutMapArr[k]), '234567')
                    //     let ind = ssArr.indexOf(aboutMapArr[k]);
                    //     if (ind === 1) {
                    //         num++;
                    //     }
                    // }
                    // console.log(num, 'num--')
                    // this.posiYObj[num] = - height/2;
                    // }
                    // 先判断下，当前策略是否是重复策略，
                    ...
                    console.log(this.parsedChartData, 'this.parsedChartData')
                    // 点击项是选中状态
                    // this.posiYObj[dubbleIndex + 1] = + height/2;
                    // this.posiYObj[dubbleIndex + 1] = this.oldPosiYObj[dubbleIndex + 1];
