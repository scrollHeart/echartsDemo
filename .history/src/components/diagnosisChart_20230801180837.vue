...
export default {
    ...
    methods: {
        ...
        updateChart() {
            ...
            this.chartRef.on('legendselectchanged', (e) => {
                ...
                if (!e.selected[e.name]) {
                            ...
                            this.optionColorArr.forEach(item => {
                                if (item.includes('/') && item.split('/').includes(key)) {
                                    item.split('/').forEach(i => {
                                        ...
                                        // this.series[this.mapObj[i]].data = [];
                                        // this.posiYObj[this.mapObj[i] + 1] = - height/2;
                                    })
                                }
                            })
                        }
                    ...
                    //     for (let k = 0; k < this.optionColorArr)
                    //     // if (aboutMapArr[j]) {

                    //     // }
                    // }
                    // this.optionColorArr.forEach((item, index) => {
                    //     if (item.name === e.name) {
                    //         this.optionColorArr.splice(index, 1);
                    //     }
                    // })
                    // 先判断下，当前策略是否是重复策略，
        ...
        console.log(this.valArrs, 'this.valArrs')
    },
    },
    mounted() {
        this.startMinute = 0;
