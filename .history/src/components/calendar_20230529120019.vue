  ...
  <div class="calendar">
    ...
    <div class="main-box">
      <div class="calendar-main-box">
        <div class="btn-box">
          <span v-show="configBtnObj.edit.show" @click="editClickHandle">编辑</span>
          <span v-show="configBtnObj.cance.show" @click="canceClickHandle">取消</span>
          <span v-show="configBtnObj.save.show" @click="saveClickHandle">保存</span>
        </div>
        <div
...
export default {
  ...
  methods: {
    ...
    selectDate(type, index) {
      // 点击编辑按钮后，可操作日历配置
      if (this.configBtnObj.edit.clicked) {
        this.$message({
          message: '请先点击编辑按钮',
          type: 'warning'
        });
    ...
    editClickHandle() {
      this.configBtnObj.edit.clicked = true;
      // 编辑按钮点击后，保存按钮显示，取消按钮显示，编辑按钮隐藏
      this.configBtnObj.save.show = true;
      this.configBtnObj.cance.show = true;
    },
    canceClickHandle() {
      this.configBtnObj.cance.clicked = true;
      // 取消按钮点击后，保存按钮隐藏，取消按钮隐藏，编辑按钮显示
      this.configBtnObj.save.show = false;
      this.configBtnObj.cance.show = false;
    },
    saveClickHandle() {
      this.configBtnObj.save.clicked = true;
