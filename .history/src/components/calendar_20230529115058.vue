  ...
  <div class="calendar">
    ...
    <div class="main-box">
      <div class="calendar-main-box">
        <div class="btn-box">
          <span v-show="configBtnObj.edit.show">编辑</span>
          <span v-show="configBtnObj.cance.show">取消</span>
          <span v-show="configBtnObj.save.show">保存</span>
        </div>
        <div
