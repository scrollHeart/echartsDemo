  ...
  <div class="calendar">
    ...
    <div class="main-box">
      <div class="calendar-main-box">
        <div class="btn-box">
          <span v-if="configBtnObj['edit']" @click="editClickHandle">编辑</span>
          <span v-if="configBtnObj['cance']" @click="canceClickHandle">取消</span>
          <span v-if="configBtnObj['save']" @click="saveClickHandle">保存</span>
        </div>
        <div
