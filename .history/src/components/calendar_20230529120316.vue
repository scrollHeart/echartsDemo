  ...
  <div class="calendar">
    ...
    <div class="main-box">
      <div class="calendar-main-box">
        <div class="btn-box">
          <span v-if="configBtnObj['edit']['show']" @click="editClickHandle">编辑</span>
          <span v-if="configBtnObj['cance']['show']" @click="canceClickHandle">取消</span>
          <span v-if="configBtnObj['save']['show']" @click="saveClickHandle">保存</span>
        </div>
        <div
